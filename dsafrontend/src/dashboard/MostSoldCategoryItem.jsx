...
export default function MostSoldCategoryItem() {
  ...
  return (
    <div className="my-12 rounded-2xl border-2 border-gray-200 bg-white p-8">
      <h1 className="text-[1.5vw] font-extrabold">
        Sales percentage by Category
      </h1>
      <div className="mt-4 flex gap-x-4">
        <div className="w-1/2 rounded-lg border-2 border-gray-300 bg-white p-4 pl-8 text-left">
          <h3 className="text-[0.9vw] font-bold">
            {sortedCategory[0].category}
          </h3>
          <h1 className="text-[1.4vw] font-extrabold text-prof-blue opacity-80">
